...
Mobile.setEncryptedText(findTestObject('Object Repository/inputPassword'), 'qcu24s4901FyWDTwXGr6XA==', 30)
...
Mobile.verifyElementVisible(findTestObject('logoSwagLabs'), 0)
